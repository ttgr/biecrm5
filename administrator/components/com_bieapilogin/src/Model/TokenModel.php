...
class TokenModel extends AdminModel
{
	 ...
	 * @since  1.0.3
	 */
	protected $text_prefix = 'COM_BIEAPILOGIN';
	 ...
	 * @since  1.0.3
	 */
	public $typeAlias = 'com_bieapilogin.token';
	 ...
	 * @since   1.0.3
	 */
	public function getTable($type = 'Token', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_bieapilogin.edit.token.data', array());
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_bieapilogin'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__bieapilogin_tokens');
				$max             = $db->loadResult();
